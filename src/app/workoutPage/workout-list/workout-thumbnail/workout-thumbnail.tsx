...
export default function WorkoutThumbnail({workout, selectedWeekdayID, visible, routineID}: Props) {
    ...
    return (
        <Pressable
            ...
            onPress={() => {
                ...
                router.push(`/workoutPage/workout-list/workout-thumbnail/${workout.id}?routineID=${routineID}`);
            }}
        >
